   ...
   <form method="post" action="" name="frmpatapp" onSubmit="return validateform()">
    <table width="532" border="3">
      <tbody>
        ...
        <tr>
          <td class="patientappointmentcolor">Mobile Number</td>
...
?>
        <tr>
          <td class="patientappointmentcolor">Gender</td>
          <td>
          <?php 
		  if(isset($_SESSION[patientid]))
		  {
        ...
        <tr>
          <td class="patientappointmentcolor">DOB</td>
          <td><input type="date" name="dob" id="dob" value="<?php echo $rspatient[dob]; ?>" <?php echo $readonly; ?> ></td>
        </tr>
        <tr>
          <td class="patientappointmentcolor"><strong>Enter Appointment Date</strong></td>
          <td><input type="date" min="<?php echo date("Y-m-d"); ?>" name="appointmentdate" id="appointmentdate"></td>
        </tr>
        <tr>
          <td class="patientappointmentcolor"><strong>Enter Appointment Time</strong></td>
          <td><input type="time" name="appointmenttime" id="appointmenttime"></td>
        </tr>   
        <tr>
          <td class="patientappointmentcolor"><strong>Department</strong></td>
          <td>
		...
		<tr>
          <td class="patientappointmentcolor"><strong>Doctors</strong></td>
          <td>
			<div id="divdoc">
			  <select name="doct" id="doct">
			  <option value="" class="patientappointmentcolor">Select doctor</option>          
			  </select>   
			</div>
          </td>
        </tr>        
        <tr>
          <td><strong class="patientappointmentcolor">Appointment reason</strong></td>
