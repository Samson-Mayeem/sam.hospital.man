...
<div class="wrapper col4">
  <div id="container">
    ...
    <table width="200" border="3">
      <tbody>
        <tr>
          <td width="34%" class="pprofile">Patient Name</td>
...
?>
        ...
        <tr>
          <td class="pprofile">Date Of Birth</td>
